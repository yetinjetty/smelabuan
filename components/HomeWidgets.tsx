...
export default function HomeWidgets({
  ...
  const animCount = useCountUp(memberCount)
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <p
            ...
            style={{
              color: '#E05A4E',
              textShadow: '0 2px 12px rgba(224,90,78,0.25)',
            }}
          >
            {animCount}
          </p>
        ...
        <button
          onClick={openNotif}
          className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 text-left active:scale-95 transition-transform duration-150 relative"
        >
          ...
          <p className="text-4xl font-extrabold leading-none text-gray-800">
                ...
                return (
                  <div
                    ...
                    className={`rounded-2xl p-4 border transition-colors ${
                      isRead ? 'bg-gray-50 border-gray-100' : 'bg-white border-gray-200'
                    }`}
                  >
                        ...
                        <div className="flex items-start justify-between gap-2">
                          ...
                          {!isRead && (
                            <button
                              ...
                              className="flex-none text-[11px] text-gray-400 underline whitespace-nowrap"
                            >
                              Mark read
                            </button>
                          )}
